        ...
        if(user){
            ...
            userInfo.findOne({'infoID': 'main'},'', function(err,info){
                ...
                if(info){
                    ...
                    // create a new mess box for the user
                    messBox.createMessBox(newUser.name, function(){

                        // first message is from dustin
                        messBox.sendMess('dustin', newUser.name, 'welcome to scriptBook! My name is Dustin, this is my pet project.');
    ...
    userInfo.findOne({'infoID': 'main'},'', function(err,info){
        ...
        if(info){
           ...
           dustin = new userRecord({
            ...
            // create a new mess box for dustin
            messBox.createMessBox('dustin', function(){
                console.log('new mess box made for dustin');
            });
