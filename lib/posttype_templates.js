...
exports.templates = {
    ...
    // template for generating a says html
    tictactoe: function(postContent){ return '<canvas data-state='+ JSON.stringify(postContent) +' class=\"tictactoe\" width=\"320\" height=\"240\" style="background: #00ff00;" ></canvas>'; 
    }
