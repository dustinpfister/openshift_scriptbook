...
postType.add((function () {
    ...
    return {
        ...
        onAction: {
            ...
            ifClass_tictactoe: function (e) {
                ...
                var box = e.target.getBoundingClientRect(),
                    ...
                    username = _.get('username').innerHTML,
                    state = JSON.parse(e.target.dataset.state),
                    postEL = e.target.parentElement,
                    _id = postEL.id.replace(/post_container_/, ''),
                    owner = postEL.dataset.postowner;
                ...
                if (username === owner) {
                    ...
                    if (state.ownersTurn) {
                        console.log('it is the owners turn');
                    }else{
                        ...
                        _.send(
                            ...
                            function(){
                                ...
                                console.log('okay i think we are good');
        ...
        postTemplate: function (postContent) {
            return '<canvas class=\"tictactoe\" width=\"320\" height=\"240\" style="background: #ff0000;" ></canvas>';
        }
    }
